...
class Face(nn.Module):
  ...
  def __init__(self, phase, size, num_classes):
    ...
    self.conv_h1_1 = BasicConv2d(256, 128, kernel_size=1, stride=1, padding=0)
    self.conv_h1_2 = BasicConv2d(128, 64, kernel_size=1, stride=1, padding=0)
    
    self.conv4_1 = BasicConv2d(256, 128, kernel_size=1, stride=1, padding=0)  
    #self.conv_dw_tr2 = depthwise_separable_conv(256, 128)  
    self.conv_dw_std2 = depthwise_separable_conv_stride2(128, 256)   
    self.conv_h2_1 = BasicConv2d(256, 64, kernel_size=1, stride=1, padding=0)
