...
class eye(nn.Module):
  ...
  def __init__(self, phase, size, num_classes):
    ...
    self.conv2 = BasicConv2d(32, 64, kernel_size=3, stride=2, padding=1)
    self.conv3 = BasicConv2d(64, 128, kernel_size=3, stride=2, padding=1)
    self.conv4 = BasicConv2d(128, 256, kernel_size=3, stride=2, padding=1)
    self.conv_h1_1 = BasicConv2d(256, 16, kernel_size=1, stride=1, padding=0)
    self.conv_h1_2 = BasicConv2d(16, 64, kernel_size=3, stride=1, padding=1)
  ...
  def multibox(self, num_classes):
    ...
    #loc_layers += [nn.Conv2d(64, 4 * 4, kernel_size=3, padding=1)]
    #conf_layers += [nn.Conv2d(64, 4 * num_classes, kernel_size=3, padding=1)]
  ...
  def forward(self, x):
    ...
    x = self.conv3(x)
    x = self.conv4(x)
    h1_1 = self.conv_h1_1(x)
    h1_2 = self.conv_h1_2(h1_1)
    detection_dimension.append(h1_2.shape[2:])
    sources.append(h1_2)
    #x = self.conv4_1(x)    
    #x = self.conv_dw_tr2(x)
    #x = self.conv_dw_std2(x)
    #h2_1 = self.conv_h2_1(x)
    #x = self.conv4_2(x)
    #detection_dimension.append(h2_1.shape[2:])
    #sources.append(h2_1)
